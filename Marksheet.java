...
import java.io.File;
public class Marksheet extends JPanel implements ActionListener
{
    JFrame f;
    JLabel d1,d2,d3,d4,r1,r2,r3,r4,r5,title,s1,s2,s3,s4,s5,tot,avg,roll,name,piclabel;
    ...
    Marksheet()
    {
        ...
        f.add(piclabel);
        //f.setVisible(true);    add this in last step of constructor otherwise textfields won't visible
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==submit)
        {
            ...
            r5.setText("FAIL");
           TOTAL=Integer.parseInt(mark1)+Integer.parseInt(mark2)+Integer.parseInt(mark3)+Integer.parseInt(mark4)+Integer.parseInt(mark5);
